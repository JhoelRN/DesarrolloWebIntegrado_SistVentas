# ==================================================
# Script: Ver operadores logísticos
# ==================================================

$mysqlPath = "C:\Program Files\MySQL\MySQL Server 8.4\bin\mysql.exe"
$sqlFile = "ver_operadores.sql"

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Consultando operadores logísticos..." -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

# Ejecutar consulta (sin solicitar contraseña, usando -padmin directamente)
