                ...
                <Row className="g-4">
                    ...
                    <Col md={2} lg={2} xs={6}>
                        ...
                        <ul className="list-unstyled small text-white-50 d-flex flex-column gap-2">
                            ...
                            <li><Link to="/info/reclamos" className="text-decoration-none text-reset hover-white transition"><i className="bi bi-book me-1"></i>Libro de Reclamaciones</Link></li>
                        </ul>
                    </Col>
                    ...
                    <Col md={4} lg={4}>
                        ...
                        <ul className="list-unstyled small text-white-50 d-flex flex-column gap-3">
                            <li className="d-flex">
                                ...
                                <span>Av. Principal 123, Mollendo,<br/>Arequipa, Perú</span>
                            </li>
